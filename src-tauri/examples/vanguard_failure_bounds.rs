...
async fn main() -> Result<()> {
    ...
    println!("Initial State -> Failovers Tracked: {}", sys_snap.node_failovers);
    ...
    println!("Post-Cascade State -> Failovers Tracked: {}", sys_snap2.node_failovers);
    assert_eq!(sys_snap2.node_failovers, 50, "Failed to track metrics accurately!");
